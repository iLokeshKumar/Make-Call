...
async def list_coach_scores(
    ...
    from services.call.call_coach_service import get_recent_coach_scores
...
async def get_coach_averages_route(
    ...
    from services.call.call_coach_service import get_coach_averages
...
async def get_coach_score_for_interaction_route(
    ...
    from services.call.call_coach_service import get_coach_score_for_interaction
