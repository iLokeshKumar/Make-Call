...
# Match URLs but exclude trailing punctuation that is typically part of surrounding markdown/text rather than the URL itself: ) ] , . ; : ! ? The negative lookbehind strips these only from the very end of the match.
